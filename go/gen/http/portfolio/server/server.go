...
// MountListHandler configures the mux to serve the "portfolio" service "list"
// endpoint.
func MountListHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("GET", "/portfolio", f)
}

// NewListHandler creates a HTTP handler which loads the HTTP request and calls
// the "portfolio" service "list" endpoint.
func NewListHandler(
...
// MountSummaryHandler configures the mux to serve the "portfolio" service
// "summary" endpoint.
...
// calls the "portfolio" service "summary" endpoint.
func NewSummaryHandler(
	...
	var (
		...
		encodeResponse = EncodeSummaryResponse(encoder)
		encodeError    = goahttp.ErrorEncoder(encoder, formatter)
	)
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		ctx := context.WithValue(r.Context(), goahttp.AcceptTypeKey, r.Header.Get("Accept"))
