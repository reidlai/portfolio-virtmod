...
// List returns an endpoint that makes HTTP requests to the portfolio service
// list server.
func (c *Client) List() goa.Endpoint {
	...
	return func(ctx context.Context, v any) (any, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("portfolio", "list", err)
		}
		return decodeResponse(resp)
	}
}

// Summary returns an endpoint that makes HTTP requests to the portfolio
...
func (c *Client) Summary() goa.Endpoint {
	...
	return func(ctx context.Context, v any) (any, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("portfolio", "summary", err)
		}
		return decodeResponse(resp)
	}
}
